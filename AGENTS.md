...
This project is indexed by GitNexus as **Fladder-Custom** (16644 symbols, 32876 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
