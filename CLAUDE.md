...
This project is indexed by GitNexus as **Fladder-Custom** (16394 symbols, 32170 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
